...
const ProductCard = ({ product, onClick }) => {
 ...
 {product.offer_price && product.offer_price < product.price ? (
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-gray-500 line-through text-xl font-bold mb-4">{product.price} AED</span>
          </div>
        ) : (
          <span className="text-gray-800 font-bold text-xl mb-4">{product.price} AED</span>
        )}
